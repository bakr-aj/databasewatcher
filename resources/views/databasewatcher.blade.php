...
<head>
    ...
    <script src="{{asset('vendor/bakraj/js/Chart.bundle.js')}}"></script>    
    <script src="{{asset('vendor/bakraj/js/jquery.min.js')}}"></script>    
...
<body>
    ...
    <div style="text-align:center">
        ...
        <script src={{asset('vendor/bakraj/js/graph.js')}}> 
        </script>
    </div>
</body>
</html>